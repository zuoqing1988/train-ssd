...
def Conv(data, num_filter=1, kernel=(1, 1), stride=(1, 1), pad=(0, 0), num_group=1, name=None, suffix=''):
    ...
    bn = mx.sym.BatchNorm(data=conv, name='%s%s_bn' %(name, suffix), fix_gamma=False)
...
def get_symbol(num_classes, **kwargs):
    ...
    conv1_ = Conv(data, num_filter=16, kernel=(3, 3), pad=(1, 1), stride=(2, 2), name="conv1_") # 224/112
    conv2_dw = Conv(conv1_, num_group=16, num_filter=16, kernel=(3, 3), pad=(1, 1), stride=(1, 1), name="conv2_dw") # 112/112
    ...
    conv4_sep = Conv(conv4_dw, num_filter=32, kernel=(1, 1), pad=(0, 0), stride=(1, 1), name="conv4_sep") # 56/56
    conv5_dw = Conv(conv4_sep, num_group=32, num_filter=32, kernel=(3, 3), pad=(1, 1), stride=(2, 2), name="conv5_dw") # 56/28
    conv5_sep = Conv(conv5_dw, num_filter=64, kernel=(1, 1), pad=(0, 0), stride=(1, 1), name="conv5_sep") # 28/28
    conv6_dw = Conv(conv5_sep, num_group=64, num_filter=64, kernel=(3, 3), pad=(1, 1), stride=(1, 1), name="conv6_dw") # 28/28
    conv6_sep = Conv(conv6_dw, num_filter=64, kernel=(1, 1), pad=(0, 0), stride=(1, 1), name="conv6_sep") # 28/28
    conv7_dw = Conv(conv6_sep, num_group=64, num_filter=64, kernel=(3, 3), pad=(1, 1), stride=(2, 2), name="conv7_dw") # 28/14
    conv7_sep = Conv(conv7_dw, num_filter=128, kernel=(1, 1), pad=(0, 0), stride=(1, 1), name="conv7_sep") # 14/14

    conv8_dw = Conv(conv7_sep, num_group=128, num_filter=128, kernel=(3, 3), pad=(1, 1), stride=(1, 1), name="conv8_dw") # 14/14
    ...
    conv9_sep = Conv(conv9_dw, num_filter=128, kernel=(1, 1), pad=(0, 0), stride=(1, 1), name="conv9_sep") # 14/14
    conv10_dw = Conv(conv9_sep, num_group=128, num_filter=128, kernel=(3, 3), pad=(1, 1), stride=(1, 1), name="conv10_dw") # 14/14
    ...
    conv11_sep = Conv(conv11_dw, num_filter=128, kernel=(1, 1), pad=(0, 0), stride=(1, 1), name="conv11_sep") # 14/14
    conv12_dw = Conv(conv11_sep, num_group=128, num_filter=128, kernel=(3, 3), pad=(1, 1), stride=(1, 1), name="conv12_dw") # 14/14
    ...
    conv13_sep = Conv(conv13_dw, num_filter=256, kernel=(1, 1), pad=(0, 0), stride=(1, 1), name="conv13_sep") # 7/7
    conv14_dw = Conv(conv13_sep, num_group=256, num_filter=256, kernel=(3, 3), pad=(1, 1), stride=(1, 1), name="conv14_dw") # 7/7
